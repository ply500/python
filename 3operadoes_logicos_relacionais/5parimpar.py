...
if ((escolhaJogador == "1") or (escolhaJogador == "ímpar") or (escolhaJogador == "Ímpar") or (escolhaJogador == "Impar")):
    escolhaJogador = "impar"
    print(f"Sua escolhaJogador foi ímpar e o número foi {numeroJogador}")
if ((escolhaJogador == "2") or (escolhaJogador == "par") or (escolhaJogador == "Par")):
    escolhaJogador = "par"
